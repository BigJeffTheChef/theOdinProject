...
/* harmony import */ var _html_templates_projectModal_html__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../html-templates/projectModal.html */ "./src/html-templates/projectModal.html");
/* harmony import */ var _html_templates_toDoCard_html__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../html-templates/toDoCard.html */ "./src/html-templates/toDoCard.html");
// function imports
...
function render_projectModal(projectObj) {
    ...
    let modal = (0,_domController_js__WEBPACK_IMPORTED_MODULE_0__.generateTemplate)(_html_templates_projectModal_html__WEBPACK_IMPORTED_MODULE_5__["default"]);
    ...
    modal.querySelector('#modal-form').appendChild((0,_domToDos_js__WEBPACK_IMPORTED_MODULE_1__.createToDoCards)(projectObj.todos));
    ...
    function pull(projectUid) {
        ...
        let p = new _obj_Project_js__WEBPACK_IMPORTED_MODULE_3__.Project(title, description, notes, projectUid);
...
function render_allTodos() {
    ...
    _domController_js__WEBPACK_IMPORTED_MODULE_0__.elements.content.appendChild(createToDoCards(loadedTodos));
};
...
/* harmony import */ var _scripts_dom_domController_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/dom/domController.js */ "./src/scripts/dom/domController.js");
/* harmony import */ var _scripts_storage_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/storage.js */ "./src/scripts/storage.js");
/* harmony import */ var _scripts_obj_Project_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/obj/Project.js */ "./src/scripts/obj/Project.js");
/* harmony import */ var _scripts_obj_ToDo_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scripts/obj/ToDo.js */ "./src/scripts/obj/ToDo.js");
...
function buildTestData() {
    (0,_scripts_storage_js__WEBPACK_IMPORTED_MODULE_3__.clearStorage)();
    // addTestToDosToStorage(7);
    let tProj = new _scripts_obj_Project_js__WEBPACK_IMPORTED_MODULE_4__.Project("ptitle1", "pdesc1", "pnotes1", 5555);
    let t1 = new _scripts_obj_ToDo_js__WEBPACK_IMPORTED_MODULE_5__.ToDo("ttitle1a", "tdesc1a", new Date(1,1,1), 1, 1111);
    let t2 = new _scripts_obj_ToDo_js__WEBPACK_IMPORTED_MODULE_5__.ToDo("ttitle1b", "tdesc1b", new Date(1,1,1), 1, 1112);
    ...
    tProj.addTodo(t1);
    tProj.addTodo(t2);
    tProj.addTodo(new _scripts_obj_ToDo_js__WEBPACK_IMPORTED_MODULE_5__.ToDo("ttitle2", "tdesc2", new Date(2,2,2), 2, 2222));

    let tProj2 = new _scripts_obj_Project_js__WEBPACK_IMPORTED_MODULE_4__.Project("ptitle2", "pdesc2", "pnotes2", 6666);
    tProj2.addTodo(new _scripts_obj_ToDo_js__WEBPACK_IMPORTED_MODULE_5__.ToDo("ttitle3", "tdesc3", new Date(3,3,3), 3, 3333));
    tProj2.addTodo(new _scripts_obj_ToDo_js__WEBPACK_IMPORTED_MODULE_5__.ToDo("ttitle4", "tdesc4", new Date(4,4,4), 4, 4444));
    (0,_scripts_storage_js__WEBPACK_IMPORTED_MODULE_3__.save)(tProj);
    (0,_scripts_storage_js__WEBPACK_IMPORTED_MODULE_3__.save)(tProj2);

    let loneT = new _scripts_obj_ToDo_js__WEBPACK_IMPORTED_MODULE_5__.ToDo("not in any project", "description - this one isnt in a project ".repeat(70), new Date(5,5,5), 5);
    loneT.notes = "test notes";
    (0,_scripts_storage_js__WEBPACK_IMPORTED_MODULE_3__.save)(loneT);

    let whatever = (0,_scripts_storage_js__WEBPACK_IMPORTED_MODULE_3__.load)("project");
    console.log(whatever);


    console.log(window['localStorage']);

    console.log((0,_scripts_storage_js__WEBPACK_IMPORTED_MODULE_3__.load)("todo"));
}
