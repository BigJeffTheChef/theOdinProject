...
function render_project(projectObj) {
    ...
    let x = (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.load)('project', projectObj.uid);
    ...
    content.querySelector('#add-button').addEventListener('click', () => (0,_domToDos_js__WEBPACK_IMPORTED_MODULE_1__.render_toDoModal)(null, () => render_project(projectObj), projectObj));
...
function render_toDoModal(toDoObj, onCloseEvent, containingProject) {
    ...
    if (!toDoObj) { // if toDoObj undefined create a new blank todo
        toDoObj = new _obj_ToDo_js__WEBPACK_IMPORTED_MODULE_2__.ToDo(null, null, null, null);
    }
    ...
    function onSave(currentUid) {
        ...
        if (containingProject !== undefined) {
            ...
            (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.save)(containingProject);
        }
    }
...
function load(toLoad, uid = null) {
    ...
    function loadProject(projectUid) {
        ...
        let p = new _obj_Project_js__WEBPACK_IMPORTED_MODULE_1__.Project(poi.title, poi.description, poi.notes, poi.uid);
    ...
    function loadProjects() {
        ...
        for (let projectUID in loadedProjects) {
            ...
            let project = new _obj_Project_js__WEBPACK_IMPORTED_MODULE_1__.Project(obj.title, obj.description, obj.notes, parseInt(projectUID));
            //console.log(project);
...
(function initialise() {
    ...
    let t = new _scripts_obj_ToDo_js__WEBPACK_IMPORTED_MODULE_4__.ToDo(null, null, null, null);
    console.log(t);
})();
