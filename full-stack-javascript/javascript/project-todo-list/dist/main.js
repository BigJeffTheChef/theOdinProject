...
function load(toLoad, uid = null) {
    ...
    function loadToDos() {
        ...
        for (let keyUid in parsedTodos) {
            ...
            //console.log(u);
            let todo = new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo(obj.title, obj.description, new Date(obj.dueDate), obj.priority, obj.uid);
...
function buildTestData() {
    ...
    let t1 = new _ToDo__WEBPACK_IMPORTED_MODULE_5__.ToDo("ttitle1", "tdesc1", new Date(1,1,1), 1, 1111);
