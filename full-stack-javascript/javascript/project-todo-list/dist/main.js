...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/styles/todo-modal.css":
/*!*************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/styles/todo-modal.css ***!
  \*************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/html-templates/toDoModal_new.html":
/*!***********************************************!*\
  !*** ./src/html-templates/toDoModal_new.html ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_todo_modal_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./todo-modal.css */ "./node_modules/css-loader/dist/cjs.js!./src/styles/todo-modal.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_todo_modal_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_todo_modal_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_todo_modal_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_todo_modal_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony import */ var _html_templates_toDoModal_new_html__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./html-templates/toDoModal_new.html */ "./src/html-templates/toDoModal_new.html");
...
function renderToDoList() {
    ...
    */
    ...
    let todoObjs = (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.loadToDos)();
    ...
    function createCard(toDoObj) {
        ...
        function dateAndPriorityCell(date, priority) {
            ...
            bottomCell.appendChild(footerCells('Due', (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date, 'dd/MM/yyyy')));
...
function renderToDoModal(toDoObj) {
    ...
    modalTemplate.innerHTML = _html_templates_toDoModal_html__WEBPACK_IMPORTED_MODULE_2__["default"];
    ...
    modalContent.querySelector('#due-date-field').value = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(toDoObj.dueDate, 'yyyy-MM-dd');
    ...
    function renderChecklist_view(checklist) {
        ...
        for (let i = 0; i < checklist.length; i++) {
            ...
            clistTemplate.innerHTML = _html_templates_toDoModal_list_html__WEBPACK_IMPORTED_MODULE_4__["default"];
    ...
    function renderChecklist_add() {
        ...
        newListItemTemplate.innerHTML = _html_templates_toDoModal_new_html__WEBPACK_IMPORTED_MODULE_3__["default"];
        ...
        newListItemContent.querySelector('#add-todo-button').addEventListener('click', (event) => {
            ...
            try {
                ...
                (0,_storage_js__WEBPACK_IMPORTED_MODULE_1__.saveToDo)(toDoObj);
                renderToDoList();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addTestProjectToStorage": () => (/* binding */ addTestProjectToStorage),
/* harmony export */   "addTestToDosToStorage": () => (/* binding */ addTestToDosToStorage),
...
const jsonStructure = __webpack_require__(/*! ./localStorageStructure.json */ "./src/localStorageStructure.json");
const jsonExample = __webpack_require__(/*! ./localStorageExample.json */ "./src/localStorageExample.json");
...
function save(objToSave) {
    ...
    */
    if (localStorageAvailable()) {
        ...
        if (objToSave instanceof _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo) {
            // save ToDo
            sTodo(objToSave);
        } else if (objToSave instanceof _Project_js__WEBPACK_IMPORTED_MODULE_1__.Project) {
            // save Project
            sProject(objToSave);
        } else {
...
function generateToDos(numToGenerate = 7) {
    let todos = [
        new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo("Test ToDo 1", "Test Description 1", new Date(1980, 0, 1), 1),
        new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo("Test ToDo 2", "Test Description 2", new Date(1985, 0, 12), 2),
        new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo("Test ToDo 3", "Test Description 3", new Date(1990, 0, 18), 3),
        new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo("Test ToDo 4", "Test Description 4", new Date(1995, 0, 19), 4),
        new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo("Test ToDo 5", "Test Description 5", new Date(2000, 0, 21), 5),
        new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo("Test ToDo 6", "Test Description 6", new Date(2005, 0, 29), 1),
        new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo("Test ToDo 7", "Test Description 7", new Date(2022, 0, 10), 2),
        new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo("Test ToDo 8", "Test Description 8", new Date(2022, 2, 12), 3),
        new _ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo("Test ToDo 9", "Test Description 9", new Date(2022, 11, 21), 4),
    ];
...
function addTestProjectToStorage(numOfProjects = 1) {
    for (let i = 0; i < numOfProjects; i++) {
        let project = new _Project_js__WEBPACK_IMPORTED_MODULE_1__.Project("Test Project", "notes for test project");
        let todos = generateToDos();
        project.todos = todos;
...
/***/ "./src/localStorageExample.json":
/*!**************************************!*\
  !*** ./src/localStorageExample.json ***!
  \**************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"projects":{"1":"stringified project 1","2":"stringified project 2"},"todos":{"1":"stringified todo 1","2":"stringigied todo 2"}}');

/***/ }),

/***/ "./src/localStorageStructure.json":
/*!****************************************!*\
  !*** ./src/localStorageStructure.json ***!
  \****************************************/
/***/ ((module) => {

module.exports = JSON.parse('{"projects":[],"todos":[]}');
...
/* harmony import */ var _styles_todo_modal_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/todo-modal.css */ "./src/styles/todo-modal.css");
...
(function debugPrints() {
    ...
    let tProj = new _Project__WEBPACK_IMPORTED_MODULE_4__.Project("ptitle", "pdesc", "pnotes", 4444);
    tProj.addTodo(new _ToDo__WEBPACK_IMPORTED_MODULE_5__.ToDo("ttitle1", "tdesc1", new Date(1,1,1), 1, 1111));
