...
for (let btn of elements.menuAddToDoBtns) {
    btn.addEventListener('click', () => (0,_domToDos_js__WEBPACK_IMPORTED_MODULE_4__.render_toDoModal)(new _obj_ToDo_js__WEBPACK_IMPORTED_MODULE_0__.ToDo(null, null, null, null), _domToDos_js__WEBPACK_IMPORTED_MODULE_4__.render_allTodos));
}
...
function render_project(projectObj) {
    ...
    content.querySelector('#add-button').addEventListener('click', () => (0,_domToDos_js__WEBPACK_IMPORTED_MODULE_1__.render_toDoModal)(null, () => render_project(projectObj)));
