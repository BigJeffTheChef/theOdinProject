...
function render_allTodos() {
    ...
    for (let todo of loadedTodos) {
        ...
        card.querySelector('.bottom-cell>div:first-child>span:last-child').textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todo.dueDate, 'do LLLL y');
...
function render_toDoModal(toDoObj) {
    ...
    modal.querySelector('#due-date-field').value = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(toDoObj.dueDate, 'yyyy-MM-dd');
