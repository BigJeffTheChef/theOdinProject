...
function render_project(projectUid) {
    ...
    content.querySelector('#add-existing-button').addEventListener('click', () => {
        render_allTodos((todo) => { projectObj.addTodo(todo); (0,_storage_js__WEBPACK_IMPORTED_MODULE_2__.save)(projectObj); render_project(projectUid); }, (todo) => {
